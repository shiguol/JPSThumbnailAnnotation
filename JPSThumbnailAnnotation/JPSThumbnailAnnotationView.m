...
- (void)setLayerProperties {
  ...
  // TODO: [self.layer insertSublayer:_bgLayer atIndex:0];
}
...
- (void)growthbig
{
  [UIView animateWithDuration:.2 animations:^{
    self.imageView.transform = CGAffineTransformMakeScale(1.35, 1.35);
...
- (void)animateBubbleWithDirection:(JPSThumbnailAnnotationViewAnimationDirection)animationDirection {
  ...
  // TODO: [self.bgLayer addAnimation:animation forKey:animation.keyPath];
}
