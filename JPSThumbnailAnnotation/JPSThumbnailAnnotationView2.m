...
NSString * const kJPSThumbnailAnnotationViewReuseID2 = @"JPSThumbnailAnnotationView2";
...
@interface JPSThumbnailAnnotationView2 ()
...
@implementation JPSThumbnailAnnotationView2
...
- (void)setupDisclosureButton {
    ...
    UIImage *disclosureIndicatorImage = [JPSThumbnailAnnotationView2 disclosureButtonImage];
